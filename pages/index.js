    ...
    <div id="menu" className="body-page">
      ...
      <header className="page-header navbar page-header-alpha scrolled-white">
        ...
        <a className="navbar-brand" href="./#">
          <span className="logo">
            <img className="light-logo" src="/img/yralogo-white.png" alt="Logo" />
          </span>
        </a>
      ...
      <div className="page-cover">
        ...
        <div
          ...
          data-bgcolor="rgba(29, 29, 29, 0.8)"
        ></div>
      </div>
      ...
      <main className="page-main page-fullpage main-anim" id="mainpage">
        ...
        <div
          className="section section-home fullscreen-md fp-auto-height-responsive main-home border-sm section-centered"
          data-section="home"
        >
              ...
              <div className="row">
                <div className="col-12 col-lg-8 text-left">
                  ...
                  <div className="title-desc">
                    <h1 className="display-4 display-title home-title text-slide-in anim-1">
                      <img
                        className="home-logo"
                        src="/img/yralogo.png"
                        alt="Logo"
                      />
                      <div className="text">YRA Solution</div>
                    </h1>
                  </div>
                </div>
                ...
                <div className="col-12 col-lg-6 text-left">
                  {/* description */}
                  <div className="title-desc">
                    <p className="anim-4">Working from heights</p>
                  </div>
        ...
        >
          <div
            className="section-cover-tier left fit bg-img"
            data-image-src="/img/items/img-sample2.jpg"
          ></div>
          {/* Begin of section wrapper */}
                  ...
                  <div className="wrapper">
                    ...
                    <div className="title-desc">
                      ...
                      <p className="anim-2 desc-decor">
                        This describes what we do and what is our mission. Lorem
                        ipsum magicum dolor sit amet, consectetur adipiscing
                        elit. Maecenas a sem ultrices neque vehicula fermentum a
                        sit amet nulla.
                      </p>
                    </div>
        ...
        >
          <div
            className="section-cover-tier right fit bg-img"
            data-image-src="/img/items/img-person.jpg"
          ></div>
          {/* Begin of section wrapper */}
          <div className="section-wrapper fullwidth fullheight with-margin center-lg-v padding-wrapper-topbottom">
            {/* content */}
              ...
              <div className="row  justify-content-between">
                <div className="col-12 col-lg-6 text-left center-v">
                  <div className="wrapper">
                    ...
                    <div className="btns-action anim-3">
                      <a
                        href="//twitter.com/miradontsoa"
                        className="btn btn-social"
                      >
                        <i className="icon fa fa-twitter"></i>
                      </a>
                      <a
                        href="//linkedin.com/miradontsoa"
                        className="btn btn-social"
                      >
        ...
        >
          <div
            className="section-cover-tier right fit bg-img"
            data-image-src="./img/items/img-sample2-square.jpg"
          ></div>
            ...
            <div className="section-wrapper fullwidth fullheight center-lg-v with-margin padding-wrapper-topbottom">
              ...
              <div className="section-content fullwidth anim text-left">
                ...
                <div className="row justify-content-between">
                    ...
                    <div className="f-wrapper">
                      ...
                      <div className="title-desc">
                        <div className="anim-2">
                          <h2 className="display-4 display-title display-decor">
                            Contact
                          </h2>
                          <p className="desc-decor">
                            For questions about our company and products found
                            on our stores, just contact us.
                          </p>
                        </div>
                  ...
                  <div className="d-none d-md-block col-12 col-md-4 col-lg-4"></div>
                </div>
              </div>
            </div>
              ...
              >
                ...
                <div className="form-input">
                  <div className="form-group form-success-gone">
                    ...
                    <div className="f-input">
                      <input
                        id="reg-email"
                        name="email"
                        className="form-control form-control-outline form-control-white"
                        type="email"
                        required
                      ...
                      <div className="btns-action">
                        <button
                          id="submit-email"
                          name="submit_email"
                          className="btn btn-arrow btn-primary form-success-gone"
                        >
                          <span className="icon">
                  ...
                  <div className="form-group mb-0">
                    <div>
                      <p className="email-ok invisible form-text-feedback form-success-visible">
          ...
          <div className="slide" id="message" data-anchor="message">
            ...
            <div className="section-wrapper fullwidth fullheight center-lg-v with-margin padding-wrapper-topbottom">
                  ...
                  <div className="section-content fullwidth anim text-left">
                    ...
                    <div className="title-desc">
                      <div className="anim-2">
                        ...
                        <p className="desc-decor">
                          For questions about our company and products found on
                          our stores. Cras vitae neque molestie, rhoncus ipsum
                          sit amet, lobortis dui. Fusce in urna sem.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="form-container form-container-card">
                        ...
                        >
                          ...
                          <div className="btns text-left d-flex justify-content-between">
                            ...
                            <button
                              id="submit-message"
                              className="btn btn-outline email_b"
                              name="submit_message"
                            >
              ...
              {/* aside content */}
              <div className="section-aside aside-bottom anim small-relative"></div>
            </div>
            {/* End of slide section wrapper */}
          </div>
      ...
      <footer id="site-footer" className="page-footer">
        ...
        <div className="footer-right">
          <p className="note">
            Site built by your friendly &nbsp;
            <a href="https://otterdevs.com">
              <span className="marked">Otterdevs</span>
            </a>
          </p>
        </div>
      </footer>
